...
//         {
//             return !Main.dedServ && GearClientConfig.Get.DyeProjectileLight;
//         }
//         public Color? color;
...
//     {
//         public static ProjectileLightDye Get => GearClientConfig.Get.DyeProjectileLight ? ModContent.GetInstance<ProjectileLightDye>() : null;
//         public override bool IsLoadingEnabled(Mod mod) => GearClientConfig.Get.DyeProjectileLight;
...
//             if (!Main.dedServ)
//             {
//                 if (ProjectileAITrack.currentAI != -1 && ProjectileAITrack.currentAI < Main.maxProjectiles)
//                 {
...
//                     Projectile proj = Main.projectile[ProjectileAITrack.currentAI];
//                     if (proj.active)
//                     {
