...
namespace Gearedup.Content.Programming
{
    public class LustruousChest : ModItem
    {
        public override bool IsLoadingEnabled(Mod mod)
        {
			return GearServerConfig.Get.Content_LustruousChest;
        }
        public override void SetDefaults()
		{
			Item.DefaultToPlaceableTile(ModContent.TileType<LustruousChestTile>());
    ...
    public class LustruousKey : ModItem
    {
		public override bool IsLoadingEnabled(Mod mod)
        {
			return GearServerConfig.Get.Content_LustruousChest;
    ...
    public class LustruousChestTile : ModTile
	{
		public override bool IsLoadingEnabled(Mod mod)
        {
			return GearServerConfig.Get.Content_LustruousChest;
		...
		public override void SetStaticDefaults()
		{
			...
			RegisterItemDrop(ModContent.ItemType<LustruousChest>(), 1);
		...
		*/
		...
		public override bool UnlockChest(int i, int j, ref short frameXAdjustment, ref int dustType, ref bool manual) {
			if (Main.dayTime)
            {
				Main.NewText("The lust were locken away", Color.Orange);
				return false;
			}
		...
		public override bool RightClick(int i, int j)
        {
			...
			if (Main.netMode == NetmodeID.MultiplayerClient && !isLocked) {
				...
				if (isLocked) {
					...
					int key = ModContent.ItemType<LustruousKey>();
		...
		public override void MouseOver(int i, int j) {
			...
			if (chest < 0) {
                ...
                {
					player.cursorItemIconID = ModContent.ItemType<LustruousChest>();
					if (Main.tile[left, top].TileFrameX / 36 == 1) {
						player.cursorItemIconID = ModContent.ItemType<LustruousKey>();
					}
